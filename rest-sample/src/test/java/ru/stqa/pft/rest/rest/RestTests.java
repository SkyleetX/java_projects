...
public class RestTests {
    ...
    private Set<Issue> getIssues() throws IOException {
        String json = getExecutor().execute(Request.Get("http://localhost/bugify/public/api/issues.json"))
    ...
    private Executor getExecutor() {
        return Executor.newInstance().auth("ba44d6d7425252c16e953b29f2bc8378", "");
    }
